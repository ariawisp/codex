...
impl ModelClient {
    ...
    /// Effective max output tokens for streaming. Defaults to 128 when unspecified.
    pub fn get_max_output_tokens(&self) -> u64 {
        self.config.model_max_output_tokens.unwrap_or(128) as u64
    }
}
